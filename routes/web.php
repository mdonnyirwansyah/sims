...
Route::middleware('auth')->group(function () {
    ...
    Route::get('data/teacher/get-subjects', [TeacherController::class, 'getSubjects'])->name('data.teacher.getSubjects');
    Route::get('data/class-room/get-student', [ClassRoomController::class, 'getStudentsByClassroom'])->name('data.class-room.getStudentsByClassroom');
    ...
    Route::prefix('grade')->name('grade.')->middleware('auth.is.administrator.or.teacher')->group(function () {
        Route::prefix('input')->name('input.')->controller(GradeController::class)->group(function () {
            Route::get('', 'index')->name('index');
            Route::post('get-data', 'getData')->name('getData');
            Route::get('get-subjects', 'getSubjects')->name('getSubjects');
            Route::get('create-classroom', 'createClassroom')->name('create-classroom');
            Route::get('create-subjects', 'createSubjects')->name('create-subjects');
            Route::post('', 'store')->name('store');
            Route::post('store-subjects', 'storeSubjects')->name('storeSubjects');
        ...
        Route::prefix('archive')->name('archive.')->controller(ArchiveController::class)->group(function () {
            Route::get('', 'index')->name('index');
            Route::post('get-data', 'getData')->name('getData');
            Route::get('edit/{lessonSchedule}', 'edit')->name('edit');
            Route::get('show/{lessonSchedule}', 'show')->name('show');
            Route::get('print/{lessonSchedule}', 'print')->name('print');
        });
    });
