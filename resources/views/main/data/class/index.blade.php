    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('data.class.create') }}" method="get">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>2022/2023</td>
                                        <td>XI IPS 1</td>
                                        <td>198012122003133005 - Bunga, S. Pd.</td>
                                        <td>
                                            <div class="d-flex align-items-center justify-content-sm-center justify-content-start">
                                                <a href="#" class="btn btn-outline-success btn-xs mr-1" data-toggle="tooltip" data-placement="top" title="Tambah Siswa">
                                                    <i class="fa fa-user-plus"></i>
                                                </a>
                                                <a href="#" class="btn btn-outline-info btn-xs mx-1" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="fa fa-pen"></i>
                                                </a>
