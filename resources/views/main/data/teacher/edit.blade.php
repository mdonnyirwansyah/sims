...
$(document).ready(function() {
    ...
    @isset($data['teacher']->user->user_detail)
    $('#gender').val("{{ $data['teacher']->user->user_detail->gender }}").change();
    $('#religion').val("{{ $data['teacher']->user->user_detail->religion }}").change();
    @endisset
});
</script>
@endpush
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        @if (isset($data['teacher']->user->user_detail->profile_picture))
                                        <div class="col-sm-4">
