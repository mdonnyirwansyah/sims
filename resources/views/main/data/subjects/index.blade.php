...
$(document).ready(function() {
    $('#subjects-table').DataTable({
        ...
        rowReorder: true,
        ajax: {
            url: '{{ route('data.subjects.getData') }}',
            type: 'GET',
        },
        columns: [
            {
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <a href="{{ route('data.subjects.create') }}" class="btn btn-primary float-right">Tambah</a>
                            </div>
                        </div>
                        <hr>
                        <div>
                            <table id="subjects-table" class="table table-bordered table-striped" style="width:100%">
                                <thead>
                                    <tr>
